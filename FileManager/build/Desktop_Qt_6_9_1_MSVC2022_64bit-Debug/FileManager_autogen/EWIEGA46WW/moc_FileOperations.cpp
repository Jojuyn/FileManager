...
template <> constexpr inline auto FileOperations::qt_create_metaobjectdata<qt_meta_tag_ZN14FileOperationsE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<FileOperations, qt_meta_tag_ZN14FileOperationsE_t>(QMC::MetaObjectFlag{}, qt_stringData,
...
void FileOperations::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (FileOperations::*)(const QString & )>(_a, &FileOperations::operationStarted, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (FileOperations::*)(const QString & , bool )>(_a, &FileOperations::operationCompleted, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (FileOperations::*)(const QString & )>(_a, &FileOperations::errorOccurred, 2))
            return;
    }
}
...
// SIGNAL 0
void FileOperations::operationStarted(const QString & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void FileOperations::operationCompleted(const QString & _t1, bool _t2)
{
